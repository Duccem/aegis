...
export const Chat = () => {
  ...
  return (
    <motion.button
      className="flex items-center justify-center border border-white text-white  gap-2  rounded-md overflow-hidden fixed origin-center bottom-4 left-1/2 z-50 p-2 cursor-pointer translate-x-[-50%] "
