...
export function ComboboxDropdown<T extends ComboboxItem>({
  ...
  const Component = (
    <Command loop shouldFilter={false} className="bg-background">
      <CommandInput
        value={inputValue}
      ...
      <CommandGroup>
        <CommandList className="max-h-[225px] overflow-auto bg-background">
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal>
      <PopoverTrigger asChild disabled={disabled} className="w-full bg-background">
