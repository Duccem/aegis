...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@/contexts/shared/ui/components/shadcn/tooltip";
    ...
    >
      ...
      >
        <div
          ...
          className="bg-background group-data-[variant=floating]:border-neutral-800 flex h-full w-full flex-col group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border  group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
