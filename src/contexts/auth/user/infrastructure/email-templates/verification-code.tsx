...
interface AegisVerifyEmailProps {
...
export default function AegisVerifyEmail({ verificationCode }: AegisVerifyEmailProps) {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Aegis Email Verification</Preview>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Text style={mainText}>
                Thanks for starting the new Aegis account creation process. We want to make sure
            ...
            <Section style={lowerSection}>
              <Text style={cautionText}>
                Aegis will never email you and ask you to disclose or verify your password, credit
          ...
          <Text style={footerText}>
            ...
            WA 98109. © 2022, Aegis, Inc.. All rights reserved. AWS is a registered trademark of{" "}
...
AegisVerifyEmail.PreviewProps = {
  verificationCode: "596853",
} satisfies AegisVerifyEmailProps;
