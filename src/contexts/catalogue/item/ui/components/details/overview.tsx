          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">150 {unit?.abbreviation}</span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-muted-foreground">Reorder Point</span>
                <span className="font-semibold">50 {unit?.abbreviation}</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">45 {unit?.abbreviation}</span>
              </div>
            </div>
          </div>
        </CardContent>
